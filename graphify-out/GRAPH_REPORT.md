# Graph Report - trackdocs  (2026-07-01)

## Corpus Check
- 2656 files · ~6,415,438 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 51347 nodes · 91515 edges · 3198 communities (2912 shown, 286 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 554 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3c72ffa9`
...
1. `Changelog` - 142 edges
2. `Graph` - 101 edges
3. `ingest_scip_json()` - 82 edges
4. `extract()` - 76 edges
5. `Communities (141 total, 52 thin omitted)` - 71 edges
6. `_labels()` - 70 edges
7. `main()` - 66 edges
8. `build_from_json()` - 65 edges
9. `_make_id()` - 64 edges
10. `DataProcessor` - 64 edges

## Surprising Connections (you probably didn't know these)
- `statusReport()` --calls--> `FileState`  [INFERRED]
  .agents/impeccable/.agents/skills/impeccable/scripts/hook-admin.mjs → src/pages/customer/CreateShipmentPage.tsx
- `runHook()` --calls--> `now`  [INFERRED]
  .agents/impeccable/.agents/skills/impeccable/scripts/hook-lib.mjs → src/data/demo.ts
- `statusReport()` --calls--> `FileState`  [INFERRED]
  .agents/impeccable/.claude/skills/impeccable/scripts/hook-admin.mjs → src/pages/customer/CreateShipmentPage.tsx
- `runHook()` --calls--> `now`  [INFERRED]
  .agents/impeccable/.claude/skills/impeccable/scripts/hook-lib.mjs → src/data/demo.ts
- `statusReport()` --calls--> `FileState`  [INFERRED]
  .agents/impeccable/.cursor/skills/impeccable/scripts/hook-admin.mjs → src/pages/customer/CreateShipmentPage.tsx

## Import Cycles
- 1-file cycle: `.agents/graphify/tests/fixtures/sample.sv -> .agents/graphify/tests/fixtures/sample.sv`

## Communities (3198 total, 286 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (150): candidates, detectorPath, __dirname, STATIC_ELEMENT_RULES, LIVE_BROWSER_SCRIPT_PARTS, candidates, detectorPath, __dirname (+142 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (274): Path, extract_elixir(), Elixir extractor. Moved verbatim from graphify/extract.py., Extract modules, functions, imports, and calls from a .ex/.exs file., extract_apex(), extract_c(), extract_cpp(), extract_csharp() (+266 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (252): Path, Any, _read_text(), _apply_symbol_resolution_facts(), _augment_js_reexport_edges(), _augment_symbol_resolution_edges(), _augment_systemverilog_semantics(), _c_collect_type_refs() (+244 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (129): Path, _agents_install(), _agents_platform_install(), _agents_platform_uninstall(), _agents_uninstall(), _always_on(), _amp_install(), _amp_legacy_cleanup() (+121 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (154): build_graph(), Graph, _bfs(), _build_http_app(), _build_server(), _communities_from_graph(), _community_header(), _compute_idf() (+146 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (156): Path, _is_noise_dir(), Return True if this directory name looks like a venv, cache, or dep dir., collect_files(), extract_bash(), extract_json(), extract_python(), Extract functions, source imports, and cross-function calls from a .sh file. (+148 more)

### Community 6 - "Community 6"
Cohesion: 0.10
Nodes (25): Path, CallflowOptions, endpoint_id(), first_list(), first_present(), infer_project_name(), load_graph(), load_labels() (+17 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (142): 0.1.0 (2026-04-03), 0.1.1 (2026-04-04), 0.1.3 (2026-04-04), 0.1.4 (2026-04-05), 0.1.5 (2026-04-05), 0.1.6 (2026-04-05), 0.1.7 (2026-04-05), 0.1.8 (2026-04-05) (+134 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (117): Path, _node_community_map(), Invert communities dict: node_id -> community_id., cluster(), Run Leiden community detection. Returns {community_id: [node_ids]}.      Commu, backup_if_protected(), _cap_filename(), _cypher_escape() (+109 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (88): DiGraph, _cross_language(), _file_category(), find_import_cycles(), god_nodes(), graph_diff(), _is_json_key_node(), Return the top_n most-connected real entities - the core abstractions.      Fi (+80 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (108): addManualContextText(), applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), applySvelteComponentVariantStyle(), averageRgb01(), buildAnnotationsForCapture(), buildInsertPlaceholderSnapshotFromDom(), buildPinElement() (+100 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (107): Path, Path, build(), build_from_json(), build_merge(), dedupe_edges(), dedupe_nodes(), deduplicate_by_label() (+99 more)
...
Cohesion: 0.03
Nodes (109): Path, _apply_resource_limits(), _canonical_graph_for_compare(), _canonical_topology_for_compare(), _changed_path_candidates(), _check_shrink(), check_update(), _drain_pending() (+101 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (94): _agents_install(), _agents_uninstall(), _install(), _kilo_install(), _kilo_uninstall(), Tests for graphify install --platform routing., Non-Windows hermes destination is unchanged (~/.hermes/skills)., Codex skill file must reference spawn_agent. (+86 more)
...
Cohesion: 0.03
Nodes (103): addManualContextText(), applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), applySvelteComponentVariantStyle(), averageRgb01(), bindEditBadgeProxy(), buildPlaceholderResizeHandles(), buildSvelteExpressionTextMap() (+95 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (92): Path, Path, _absolutize_source_files_in(), _body_content(), cache_dir(), cached_files(), check_semantic_cache(), _cleanup_stale_ast_entries() (+84 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (25): Path, Resolve Bash source/import edges and source-backed function calls.      Defens, resolve_bash_source_edges(), When a callee function is defined in multiple sourced files, skip it., Non-bash raw_calls inside sourced-file per_file entries are ignored., A `bash_sources` entry missing `target_path` must not raise KeyError., A node tagged as bash_function but missing `id` must not raise KeyError., A raw_call entry missing `caller_nid` must not raise KeyError. (+17 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (99): Path, Path, Path, Path, Path, _check_tree_sitter_version(), extract(), _is_type_like_definition() (+91 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (56): Any, Path, check_graph_file_size_cap(), Raise ValueError if *url* is not http or https, or targets a private/internal IP, Resolve *path* and verify it stays inside *base*.      *base* defaults to the, Reject *path* if its size exceeds the configured graph-file cap.      Protects, Strip control characters and cap length.      Safe for embedding in JSON data, Return a control-character-free, HTML-escaped, bounded string. (+48 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (93): Path, extract_js(), extract_svelte(), _load_tsconfig_aliases(), Walk up from start_dir to find tsconfig.json and return compilerOptions.paths al, Extract classes, functions, arrow functions, and imports from a .js/.ts/.tsx fil, Extract imports from .svelte files: script-block via JS AST + template regex fal, Resolve a JS/TS module path or specifier to a local source file.      With a P (+85 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (85): addSteerMarkerToSource(), allIndexesOf(), applyCoupledSourceKeyRenames(), applyCoupledSourceKeyRenamesForEntry(), applyManualEditBatchToSource(), applySteerEdits(), braceDelta(), buildPreservedVariantAttrs() (+77 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (94): Path, BaseException, _anthropic_content(), _azure_client(), _backend_env_keys(), _backend_pkg_hint(), _backend_supports_vision(), _bedrock_content() (+86 more)
...
Cohesion: 0.05
Nodes (46): _entropy(), Shannon entropy in bits/char of the normalised label., Return k-gram character shingles of text., _shingles(), _make_nodes(), Tests for graphify/dedup.py entity deduplication pipeline., deduplicate_entities accepts dedup_llm_backend without crashing when no ambiguou, build() should deduplicate near-identical nodes across extractions. (+38 more)

### Community 36 - "Community 36"
Cohesion: 0.10
Nodes (47): Any, Counter, Path, Path, _canonical_edge(), _count_extra(), diagnose_extraction(), diagnose_file() (+39 more)

### Community 37 - "Community 37"
Cohesion: 0.08
Nodes (76): abortSvelteComponentInjection(), applySavedSessionMeta(), buildPickedAnchorSnapshot(), cancelEditing(), cancelEditingToPicking(), cancelInsertConfigure(), captureAndEmit(), cleanup() (+68 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (66): addBrowserFindings(), addVisualContrastFindings(), addVisualContrastResult(), analyzeVisualContrast(), analyzeVisualContrastCandidate(), blendRgba(), browserDesignSystemConfig(), browserFindingsFromMap() (+58 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (70): agentChoiceSmokeFile(), args, assertCount(), assertNoPluginInstall(), assertNoSpecificFontIgnoreConfig(), assertPath(), assertSpecificFontIgnoreConfig(), badFixtureContent() (+62 more)
...
Cohesion: 0.07
Nodes (60): assertStringValue(), bareTextElementText(), decodeBasicHtmlEntities(), __dirname, elementVisibleText(), entryHasNumericToTextOp(), entryHasResolvableCandidateEvidence(), entryHasUsableSourceHints() (+52 more)
...
Cohesion: 0.05
Nodes (52): assertApplyDockLoading(), assertApplyDockVisible(), assertSourceApplied(), clickApplyEdits(), clickEditBadgeButton(), clickEditCopy(), clickGo(), clickSaveEdit() (+44 more)
...
Cohesion: 0.04
Nodes (68): codebuddy_install(), codebuddy_uninstall(), _install_codebuddy_hook(), Install the graphify skill and CODEBUDDY.md section for CodeBuddy., Add graphify PreToolUse hook to .codebuddy/settings.json., Remove the graphify skill tree (SKILL.md + references/) and the CODEBUDDY.md sec, _codebuddy_install_user(), _codebuddy_md_path() (+60 more)
...
Cohesion: 0.08
Nodes (50): ASSETS_DIR, __dirname, initCommand(), InitOptions, tryGitHubInstall(), removeSkillDir(), uninstallCommand(), UninstallOptions (+42 more)
...
Cohesion: 0.10
Nodes (38): applySavedSessionMeta(), buildInsertPlaceholderSnapshotFromDom(), buildPickedAnchorSnapshot(), captureAndEmit(), checkpointPayload(), clampVariantIndex(), compileShader(), enterRecoveryWaitingForAnchor() (+30 more)
...
Cohesion: 0.10
Nodes (31): _crossfile_fileanchored_blocked(), deduplicate_entities(), _is_code(), _is_variant_pair(), _llm_tiebreak(), _make_minhash(), _norm(), _numeric_tokens_differ() (+23 more)
...
Cohesion: 0.08
Nodes (45): applyPlaceholderDimensions(), applySavedSessionMeta(), buildInsertPlaceholderSnapshotFromDom(), buildPickedAnchorSnapshot(), captureAndEmit(), checkpointPayload(), clampVariantIndex(), compileShader() (+37 more)
...
Cohesion: 0.07
Nodes (44): assertAnnotationUploadEvent(), clickDiscard(), clickNext(), clickPrev(), getVisibleVariant(), waitForBarHidden(), waitForHandshake(), readVisibleVariantForCycle() (+36 more)
...
Cohesion: 0.05
Nodes (48): extract_corpus_parallel(), _merge_into(), _pack_chunks_by_tokens(), Greedily pack files/slices into chunks that fit a token budget.      Units are, Extract a corpus in chunks, merging results.      Chunking strategy:, Append a chunk result into the running merged accumulator., no_tokenizer(), Tests for token-aware chunking and parallel chunk execution in graphify.llm. (+40 more)
...
Cohesion: 0.08
Nodes (46): extract_delphi_form(), extract_lazarus_form(), extract_lazarus_package(), extract_pascal(), Extract component hierarchy from Lazarus .lfm form files.      .lfm is a text-, Extract component hierarchy from Delphi .dfm form files.      .dfm files come, Extract package metadata from Lazarus .lpk package files (XML format).      .l, Extract units, classes, procedures, uses-imports, and calls from Pascal/Delphi f (+38 more)

### Community 143 - "Community 143"
Cohesion: 0.07
Nodes (38): Path, TestClient, _fake_anthropic(), _fake_boto3(), _fake_openai(), _make_corpus(), Tests for image-vision support across the direct extraction backends.  Covers, A corpus with one raster image, one svg (text), and one markdown doc. (+30 more)
...
Cohesion: 0.08
Nodes (42): ROOT, CATEGORY_ORDER, SKILL_CATEGORIES, appendYamlObject(), cleanDir(), compileProviderBlocks(), CURATED_CATEGORIES, DETECTOR_EXTERNAL_DEPS (+34 more)

### Community 159 - "Community 159"
Cohesion: 0.05
Nodes (49): _devin_install_user(), Tests for graphify devin install / uninstall commands., The rules file installed by devin must use query-first policy., Installing rules twice does not change content and prints 'no change'., Project-scope install prints a git add hint covering .devin/ and .windsurf/., User-scope uninstall removes the skill file., User-scope uninstall prints an appropriate message when nothing is installed., Project-scope uninstall removes .devin/skills/graphify/SKILL.md. (+41 more)
...
Cohesion: 0.08
Nodes (47): Any, Path, Path, _get_extractor(), Return the correct extractor function for a file, or None if unsupported., extract_mcp_config(), is_mcp_config_path(), Return True when ``path`` is a recognised MCP config filename. (+39 more)
...
Cohesion: 0.06
Nodes (50): Path, Enum, _auto_follow_symlinks(), convert_office_file(), _could_contain_included_path(), count_words(), docx_to_markdown(), _env_command_args() (+42 more)

### Community 190 - "Community 190"
Cohesion: 0.10
Nodes (41): clickPickToggle(), liveUiSnapshot(), runPreActions(), waitForCyclingRobust(), resolveSteerSourceFile(), runSteerSmoke(), assertBottomBarIdle(), barButtonMatch() (+33 more)
...
Cohesion: 0.08
Nodes (45): Path, _community_article(), _cross_community_links(), _god_node_article(), _index_md(), Make a label safe for use as a filename across platforms.      Substitutes cha, Generate a Wikipedia-style wiki from the graph.      Writes:       - index.md, Return (community_label, edge_count) pairs for cross-community connections, sort (+37 more)
...
Cohesion: 0.16
Nodes (20): assert_valid(), Validate an extraction JSON dict against the graphify schema.     Returns a lis, Raise ValueError with all errors if extraction is invalid., validate_extraction(), Result passes Graphify's validate_extraction and build_from_json keeps the edges, test_relationship_edges_survive_validate_extraction_and_build(), test_assert_valid_passes_silently(), test_assert_valid_raises_on_errors() (+12 more)

### Community 222 - "Community 222"
Cohesion: 0.08
Nodes (41): createCustomer(), CreateCustomerInput, createShipment(), createShipmentRecord(), exportShipmentsCsv(), fetchCustomerShipmentSnapshotList(), fetchCustomerSnapshotList(), fetchShipmentSnapshotList() (+33 more)

### Community 223 - "Community 223"
Cohesion: 0.07
Nodes (41): Processor, handle_delete(), handle_enrich(), handle_get(), handle_list(), handle_search(), API module - exposes the document pipeline over HTTP. Thin layer over parser, v, Fetch a document by ID and return it. (+33 more)

### Community 224 - "Community 224"
Cohesion: 0.10
Nodes (21): ConnectError, An error occurred at the transport layer., Failed to establish a connection., TimeoutException, TransportError, Request, AsyncBaseTransport, AsyncHTTPTransport (+13 more)
...
Cohesion: 0.08
Nodes (18): IProcessor, Processor, Result, HttpClient, List, Result, Result, BaseProcessor (+10 more)
...
Cohesion: 0.10
Nodes (41): Path, prefix_graph_for_global(), prune_repo_from_graph(), Return a copy of G with all node IDs prefixed with repo_tag::.      Labels are, Remove all nodes tagged with repo_tag from G in-place. Returns count removed., _file_hash(), global_add(), global_list() (+33 more)
...
Cohesion: 0.06
Nodes (49): Path, extract_razor(), ASP.NET Razor component extractor. Moved verbatim from graphify/extract.py., Extract directives, component refs, and @code methods from .razor/.cshtml., extract_csproj(), extract_sln(), extract_slnx(), _project_xml_is_safe() (+41 more)

### Community 275 - "Community 275"
Cohesion: 0.23
Nodes (38): Path, _extract_for(), _has_edge(), _has_no_symbol_to_symbol_edge(), _has_symbol_edge(), _has_symbol_to_symbol_edge(), packages: - '.' in pnpm-workspace.yaml must not raise IndexError on any Python v, test_default_import_call_resolves_to_default_exported_function() (+30 more)

### Community 277 - "Community 277"
Cohesion: 0.05
Nodes (40): dependencies, browser-image-compression, clsx, date-fns, firebase, @hookform/resolvers, lucide-react, puppeteer (+32 more)

### Community 278 - "Community 278"
Cohesion: 0.11
Nodes (41): CompletedProcess, Path, _make_graph(), Integration tests for graphify export subcommands and CLI commands.  Each test, #1423: `graphify extract` honours GRAPHIFY_OUT for where it WRITES, not only, Build a minimal graph.json + analysis/labels files in tmp_path/graphify-out/., cluster-only must not crash with FileNotFoundError when graphify-out/ is absent, cluster-only must invoke remap_communities_to_previous so the existing     .gra (+33 more)
...
Cohesion: 0.07
Nodes (37): Tests for graphify.semantic_cleanup.validate_semantic_fragment (#825)., Invalid JSON returns an error instead of raising., A node with file_type='rationale' is removed wholesale., Sentence-like rationale node connected via `rationale_for` → attribute on target, F3: a node with file_type='document' (allowed) that is BOTH sentence-like     A, A short named node with a period (e.g. abbreviation) is NOT sentence-like., F4: hyperedges referencing removed nodes are repaired or dropped., A hyperedge referencing only nodes not present in the fragment is dropped. (+29 more)
...
Cohesion: 0.07
Nodes (29): ansi(), canStyleTerminal(), clampIndex(), copyOrExtractLocalBundle(), DEFAULT_TARGETS, __dirname, downloadAndExtractBundle(), downloadFile() (+21 more)

### Community 288 - "Community 288"
Cohesion: 0.13
Nodes (14): ImagePreview(), ImagePreviewProps, SearchFilterBarProps, ShipmentCardProps, ShipmentDetailPanelProps, ShipmentTableProps, StatusBadge(), toneClasses (+6 more)

### Community 289 - "Community 289"
Cohesion: 0.08
Nodes (35): Path, build_whisper_prompt(), download_audio(), _get_whisper(), _get_yt_dlp(), is_url(), _model_name(), Transcribe a video/audio file or URL to a .txt transcript.      If video_path (+27 more)

### Community 290 - "Community 290"
Cohesion: 0.05
Nodes (37): scripts, audit, bench:detector, bench:detector:browser, build, build:browser, build:extension, build:release (+29 more)

### Community 291 - "Community 291"
Cohesion: 0.11
Nodes (5): AsyncClient, Client, Asynchronous HTTP client., Synchronous HTTP client., Response
...
Cohesion: 0.07
Nodes (40): AdminCustomersPage(), AdminDashboardPage(), AdminReportsPage(), emptyFilters, ReportFilters, useAuth(), AppShell(), AppShellProps (+32 more)
...
Cohesion: 0.10
Nodes (27): generateApiData(), readPatterns(), restorePerProjectArtifacts(), stashPerProjectArtifacts(), createAllZips(), createProviderZip(), assembleUniversal(), build() (+19 more)
...
Cohesion: 0.03
Nodes (111): ingest_scip_json(), Convert a SCIP-style JSON document into Graphify nodes and edges.      Paramet, Comprehensive tests for graphify.scip_ingest., Symbol ending with '#' and no display_name must produce a non-empty label., Cross-document relationship resolves to the target document's node id., A relationship targeting a symbol NOT in any document creates a stub external no, `relative_path` as a non-string falls back to the function's source_file default, `language` as a non-string falls back to the function default. (+103 more)

### Community 301 - "Community 301"
Cohesion: 0.10
Nodes (21): BottomNavigation(), ImageUploader(), ImageUploaderProps, MobileTopHeader(), ReceiveDialog(), ReceiveDialogProps, SegmentedFilter(), SegmentedFilterProps (+13 more)
...
Cohesion: 0.08
Nodes (31): allAntipatterns, badge, btnCopyAll, btnRescan, btnSettings, btnToggle, container, currentFindings (+23 more)
...
Cohesion: 0.11
Nodes (35): Path, Path, _best_cut(), bisect_slice(), expand_oversized_files(), FileSlice, is_splittable_text(), Intra-file slicing for oversized text documents (#1369).  The extraction packe (+27 more)
...
Cohesion: 0.08
Nodes (24): ../scripts/app.js, ../../scripts/components/live-demo.js, ../../scripts/utils/copy-feedback.js, ../scripts/utils/theme.js, ../styles/changelog-faq-kinpaku.css, ../../styles/design-system.css, ../../styles/designing-kinpaku.css, ../styles/footer.css (+16 more)

### Community 335 - "Community 335"
Cohesion: 0.06
Nodes (33): 1. Overview: Neo Kinpaku, 2. The Kit: One Vocabulary For Every Page, 3. Colors: Lacquer, Gold, Patina, 4. Typography: Two faces, weight inversion at the top, 5. Elevation and Material, 6. Components, 7. Do and Do Not, All values below mirror site/styles/kinpaku-tokens.css verbatim. That file (+25 more)

### Community 336 - "Community 336"
Cohesion: 0.09
Nodes (11): BaseClient, Limits, The main Client and AsyncClient classes. BaseClient holds all shared logic. Cli, Shared implementation for Client and AsyncClient.     Handles auth, redirects,, Timeout, InvalidURL, URL is improperly formed or cannot be parsed., Cookies (+3 more)
...
Cohesion: 0.14
Nodes (16): HttpClient, main(), string, Config, Int, String, Bool, AuthedHttpClient (+8 more)
...
Cohesion: 0.13
Nodes (19): beginEditPin(), buildAnnotationsForCapture(), buildPinElement(), cancelEditingPin(), clampPlaceholderSize(), finalizeEditingPin(), localCoords(), materializePlaceholderWidth() (+11 more)
...
Cohesion: 0.06
Nodes (28): devDependencies, svelte, @sveltejs/adapter-auto, @sveltejs/kit, @sveltejs/vite-plugin-svelte, vite, name, private (+20 more)
...
Cohesion: 0.11
Nodes (24): initGlassTerminal(), renderTerminalLayout(), initGbarPageChat(), initLiveDemo(), PALETTE_ACTIONS, PHASE, TIMELINE, initSectionNav() (+16 more)
...
Cohesion: 0.08
Nodes (28): detect_incremental(), load_manifest(), Load the manifest from a previous run. Returns {} on any error.      When ``ro, Save current file mtimes + content hashes for change detection.      kind="ast, Like detect(), but returns only new or modified files since the last run., save_manifest(), ``save_manifest(root=...)`` writes forward-slash relative keys., Back-compat: callers that don't pass ``root`` still get the legacy     absolute (+20 more)
...
Cohesion: 0.16
Nodes (14): CustomerDraft, emptyDraft, AdminUsersPage(), emptyDraft, roleOptions, UserDraft, ConfirmDialog(), ConfirmDialogProps (+6 more)
...
Cohesion: 0.11
Nodes (15): commandDemos, getCommandDemo(), formatName(), renderComingSoonVisual(), renderFrame(), renderGallery(), setupInteractions(), renderSkillDemo() (+7 more)

### Community 494 - "Community 494"
Cohesion: 0.11
Nodes (22): SVELTE_PROJECT_FILES, bashCommandsMatching(), cleanupWorkspace(), __dirname, fileLoaded(), makeTools(), prepareWorkspace(), readsMatching() (+14 more)

### Community 495 - "Community 495"
Cohesion: 0.07
Nodes (28): Changelog, How to pin to v1 if you need it, Repo, Stability note, [Unreleased], v1 - the original taste-skill, v2 (experimental) - the new default for `taste-skill`, What's new in v2 (experimental) (+20 more)
...
Cohesion: 0.08
Nodes (24): Brug, Bygget på graphify — Penpax, Hvad du får, Installation, Privatliv, Sådan fungerer det, Asennus, Käyttö (+16 more)
...
Cohesion: 0.06
Nodes (49): Path, Any, Path, Path, _file_stem(), _make_id(), make_id(), normalize_id() (+41 more)
...
Cohesion: 0.10
Nodes (27): _e(), generate_chart_slide(), generate_cta_slide(), generate_deck(), generate_metrics_slide(), generate_problem_slide(), generate_solution_slide(), generate_testimonial_slide() (+19 more)

### Community 532 - "Community 532"
Cohesion: 0.07
Nodes (22): args, branch, changelogHtml, changelogSource, component, COMPONENTS, dryRun, entryHtml (+14 more)
...
Cohesion: 0.07
Nodes (27): author, bin, uipro, dependencies, chalk, commander, ora, prompts (+19 more)

### Community 569 - "Community 569"
Cohesion: 0.12
Nodes (26): showHelp(), aggregateEvents(), BROWSER_FIXTURES, closeServer(), __dirname, FIXTURES, isHtml(), main() (+18 more)

### Community 570 - "Community 570"
Cohesion: 0.12
Nodes (20): categoryLabels, categoryOrder, fetchCommandSource(), goToSpread(), initSpreadDemo(), isMobile(), magazineState, PALETTE_EXCLUDED (+12 more)

### Community 571 - "Community 571"
Cohesion: 0.09
Nodes (20): _build_opener(), _ip_is_blocked(), _max_graph_file_bytes(), _NoFileRedirectHandler, Resolve *host* once and return (family, validated_ip) for the first     address, HTTPConnection that resolves + validates DNS once, then connects to the     exa, HTTPSConnection variant of _SSRFGuardedHTTPConnection.      Connects to the va, urllib handler that routes http:// through _SSRFGuardedHTTPConnection. (+12 more)
...
Cohesion: 0.07
Nodes (11): Tests for the `claude-cli` backend (#855/#856).  Mocks subprocess.run + shutil, On Windows, npm installs `claude.ps1` alongside `claude.cmd`.     `CreateProces, If `claude.cmd` is somehow unavailable but `claude` resolves     (e.g. WSL-styl, If neither `claude.cmd` nor `claude` are on PATH on Windows,     raise the stan, On non-Windows platforms, behaviour is unchanged: bare `claude`     is passed t, The label/_simple_completion path must spawn the resolved claude.cmd on     Win, test_non_windows_uses_bare_claude(), test_simple_completion_resolves_cmd_shim_on_windows() (+3 more)
...
Cohesion: 0.12
Nodes (33): addColorObject(), addDesignColor(), addRoundedScale(), addRoundedToken(), addSidecarColors(), addSidecarRadii(), addTypographyFonts(), canonicalDesignFindingKey() (+25 more)
...
Cohesion: 0.07
Nodes (26): Adding editorial content for existing commands, Adding New Commands, Adding or modifying anti-pattern detection rules, After structural skill changes, update `inline-skill.ts` in the evals repo, Architecture (v3.0+), Build System, CLI, Color token rule (+18 more)
...
Cohesion: 0.08
Nodes (13): Tests for tailwind_config_gen.py, Test adding custom spacing., Test TailwindConfigGenerator class., Test initialization with default settings., Test generating JavaScript configuration., Test generating config with plugins., Test validating config with no content paths., Test writing configuration to file. (+5 more)
...
Cohesion: 0.13
Nodes (23): appendOriginToDirective(), buildTagBlock(), commentClose(), commentOpen(), CONFIG_PATH, detectLineEnding(), __dirname, ensureLiveGitIgnores() (+15 more)
...
Cohesion: 0.06
Nodes (42): Any, _build_scip_metadata(), _coerce_str(), _emit_relationships(), _emit_symbol_node(), _first_occurrence_line(), _is_true(), _make_scip_node_id() (+34 more)
...
Cohesion: 0.11
Nodes (23): Counter, derive_flow_chain(), edge_score(), generate_overview_cards(), generate_section_cards(), node_degree_scores(), node_importance(), preferred_edges() (+15 more)
...
Cohesion: 0.14
Nodes (18): allChanged(), getChangedFiles(), git(), gitDiffNames(), plan, args, formatCommand(), requestedSuites (+10 more)

### Community 698 - "Community 698"
Cohesion: 0.15
Nodes (24): averageRgb01(), buildRows(), captureElementFromRenderedAncestor(), captureElementToBlob(), clearOverlays(), compileShader(), dominantRgb01(), findBackdropAncestor() (+16 more)
...
Cohesion: 0.13
Nodes (23): Path, affected_nodes(), AffectedHit, _bare_name(), format_affected(), _format_location(), load_graph(), _node_label() (+15 more)
...
Cohesion: 0.13
Nodes (33): Path, attach_graph_impact(), bold(), _c(), _ci_icon(), cmd_prs(), cyan(), _detect_default_branch() (+25 more)

### Community 721 - "Community 721"
Cohesion: 0.13
Nodes (24): Any, Path, _log_path(), log_query(), _log_responses(), nodes_from_result(), Query logging for graphify — append-only JSONL, fail-silent., Append one JSONL record to the query log. Never raises. (+16 more)
...
Cohesion: 0.09
Nodes (16): PROVIDER_BLOCK_TAGS, PROVIDER_PLACEHOLDERS, TEST_DIR, transformAgents, transformClaudeCode, transformCodex, transformCursor, transformGemini (+8 more)
...
Cohesion: 0.09
Nodes (3): _ok(), Tests for direct semantic-extraction backend selection., test_extract_corpus_parallel_ollama_parallel_env_restores_concurrency()

### Community 726 - "Community 726"
Cohesion: 0.08
Nodes (23): Tests for the tools/skillgen generator and the claude lean-core split.  skillg, Every v8 heading single-homes for the cli-inline split hosts too., Every v8 heading lands in the lean core or exactly one reference., check + audit-coverage pass for every rendered progressive host., aider and devin render one inline body, no split and no references dir., Each monolith is diff-clean vs v8 except the file_type enum unification., Rendering twice yields byte-identical output (no timestamps/versions)., Every line that differs from pristine v8 is a sanctioned change-class.      Th (+15 more)
...
Cohesion: 0.11
Nodes (19): foundationAnimations, initFoundationGrid(), categoryColors, categoryLabels, commandDisplay, commandNumbers, commandSymbols, initFrameworkViz() (+11 more)

### Community 761 - "Community 761"
Cohesion: 0.09
Nodes (34): Any, datetime, Path, _decay(), _dedupe_by_question(), _doc_community(), _empty_bucket(), _finalize_sources() (+26 more)
...
Cohesion: 0.13
Nodes (19): checkFontStack(), checkRadiusValue(), checkSourceDesignSystem(), collectStaticDesignSystemFindings(), colorsClose(), decodeGoogleFamily(), dedupeDesignFindings(), extractRadiusTokens() (+11 more)
...
Cohesion: 0.09
Nodes (22): Built on graphify — Penpax, Common commands, Development setup, Environment variables, Full command reference, Git workflow, Ignoring files, Install (+14 more)

### Community 766 - "Community 766"
Cohesion: 0.09
Nodes (23): MobileShipmentDetail(), MobileShipmentDetailProps, safeFmt(), ShipmentDetailPanel(), firebaseApiKey, firebaseAppId, firebaseAuthDomain, firebaseConfig (+15 more)
...
Cohesion: 0.10
Nodes (17): Card, CardDescription, CardIcon, CardTitle, FeatureGrid(), features, Grid, CTAButton (+9 more)
...
Cohesion: 0.17
Nodes (15): ../../data/sub-pages-data, ../scripts/demo-renderer.js, ../scripts/demos/commands/index.js, ../scripts/effects/split-compare.js, ../../styles/docs-kinpaku.css, ../../components/DocsSidebar.astro, reference, referenceGroups (+7 more)
...
Cohesion: 0.09
Nodes (21): action, default_icon, default_popup, background, service_worker, 128, 16, 32 (+13 more)

### Community 787 - "Community 787"
Cohesion: 0.09
Nodes (21): 1. Overview, 2. Colors, 3. Typography, 4. Elevation, 5. Components, 6. Do's and Don'ts, Buttons, Cards (Feature Tiles) (+13 more)

### Community 788 - "Community 788"
Cohesion: 0.13
Nodes (17): buildApiProxyRewrites(), buildCSPConfig(), buildSecurityHeaders(), buildWebpackConfig(), createBaseNextConfig(), CSPConfig, DEFAULT_WORKSPACE_TRANSPILE_PACKAGES, KNOWN_SUPABASE_CUSTOM_DOMAINS (+9 more)
...
Cohesion: 0.24
Nodes (20): ACTION_ALIASES, addFile(), addRule(), addValue(), clear(), formatConfig(), formatValues(), ignoreValueKey() (+12 more)

### Community 819 - "Community 819"
Cohesion: 0.17
Nodes (21): check(), copyDirSync(), copyProviderSkills(), decideHookInstall(), deduplicateProviders(), findInstalledProviders(), findLinkedProviders(), findProjectRoot() (+13 more)
...
Cohesion: 0.12
Nodes (16): Any, Path, convert_google_workspace_file(), _extract_file_id_from_url(), _extract_resource_key(), google_workspace_enabled(), Optional Google Workspace shortcut export support.  Google Drive for desktop s, Export a Google Workspace shortcut to a Markdown sidecar.      Returns the con (+8 more)
...
Cohesion: 0.11
Nodes (18): _make_envelope(), Tests for `_parse_llm_json` robustness and the `_call_claude_cli` subprocess ar, The hollow-response root cause was --append-system-prompt     layering graphify, GRAPHIFY_CLAUDE_CLI_MODEL must be forwarded to claude -p --model., Default behaviour: when the env var is not set, --model is not     added so cla, Claude often prefixes the JSON with a short preamble before the     ```json fen, Some models return prose around bare JSON with no markdown fence.     The balan, Regression: clean JSON input (the original happy path) must keep     parsing ex (+10 more)
...
Cohesion: 0.18
Nodes (18): AuthContext, AuthContextValue, AuthProvider(), AuthSession, createSessionFromCredential(), debugAuth(), getFirebaseAuthErrorCode(), isUserRole() (+10 more)

### Community 857 - "Community 857"
Cohesion: 0.10
Nodes (19): Accept variant, Action bar (floating, contextual), ADR: Live Variant Mode, Architecture, Browser UI, Context, Decision, Discard (+11 more)

### Community 858 - "Community 858"
Cohesion: 0.13
Nodes (23): Path, _git_root(), _hooks_dir(), _install_hook(), Walk up to find .git directory., Raise if a hooks path looks like a Windows absolute path (#1385).      On POSI, Return the git hooks directory, respecting core.hooksPath if set (e.g. Husky)., # NOTE: do NOT pass --path-format=absolute — added in git 2.31; older git (+15 more)

### Community 859 - "Community 859"
Cohesion: 0.10
Nodes (32): Path, _detect_url_type(), _download_binary(), _fetch_arxiv(), _fetch_html(), _fetch_tweet(), _fetch_webpage(), _html_to_markdown() (+24 more)
...
Cohesion: 0.10
Nodes (19): _enum_lines(), _is_cache_unlink_fix_line(), _is_chunk_cleanup_line(), _is_content_scope_fix_line(), _is_directed_fix_line(), _is_enum_line(), _is_frontmatter_description_line(), _is_manifest_root_fix_line() (+11 more)
...
Cohesion: 0.15
Nodes (16): bootLive(), __dirname, LIVE_POLL_SCRIPT, LIVE_SCRIPT, LIVE_SERVER_SCRIPT, REPO_ROOT, run(), runLiveContextMissing() (+8 more)
...
Cohesion: 0.17
Nodes (12): RoleGuardProps, navigationByRole, SidebarProps, Topbar(), TopbarProps, UpdateUserProfileInput, roleAccent, roleHomePath (+4 more)

### Community 896 - "Community 896"
Cohesion: 0.11
Nodes (18): author, bin, impeccable, description, engines, node, exports, ./browser (+10 more)
...
Cohesion: 0.11
Nodes (17): dependencies, react, react-dom, devDependencies, tailwindcss, vite, @vitejs/plugin-react, name (+9 more)
...
Cohesion: 0.11
Nodes (18): devDependencies, ai, @ai-sdk/anthropic, @ai-sdk/google, @ai-sdk/openai, @anthropic-ai/claude-agent-sdk, @anthropic-ai/sdk, archiver (+10 more)
...
Cohesion: 0.29
Nodes (10): _normalise(), Read a fragment file under fragments/, normalised to LF newlines., Force LF newlines and exactly one trailing newline., Fill the shared core template's per-platform slots for this platform., Fill the agents-md hooks template's per-host slots for this platform.      The, Render every committed artifact for one platform.      A split platform yields, _read_fragment(), render() (+2 more)
...
Cohesion: 0.16
Nodes (17): _clear_backend_keys(), _code_only_corpus(), _make_corpus(), Tests for `graphify extract` CLI dispatch path in graphify.__main__., Minimal corpus: one Go code file + one Markdown doc.      Both file types are, A corpus with only code — no docs/papers/images., Clear every env var that detect_backend() or _get_backend_api_key() reads., A code-only corpus must run with no LLM API key.      Regression: graphify ext (+9 more)
...
Cohesion: 0.11
Nodes (16): Co získáte, Instalace, Jak to funguje, Postaveno na graphify — Penpax, Použití, Soukromí, graphify, Worked examples (+8 more)
...
Cohesion: 0.12
Nodes (9): IProcessor, SampleUnit, TBaseProcessor, TDataProcessor, Process(), Reset(), IProcessor, TBaseProcessor (+1 more)
...
Cohesion: 0.12
Nodes (16): dependencies, react, react-dom, devDependencies, tailwindcss, vite, @vitejs/plugin-react, name (+8 more)
...
Cohesion: 0.18
Nodes (15): createLlmAgent(), resolveLlmAgentConfig(), resolveProvider(), collectAcceptedDomDiagnostic(), extractClassAttr(), isSourceClean(), loadEnvLocal(), locateSessionFile() (+7 more)
...
Cohesion: 0.20
Nodes (15): templateInstall(), AI_TO_PLATFORM, ASSETS_DIR, copyDataAndScripts(), __dirname, ensureCleanDir(), exists(), generateAllPlatformFiles() (+7 more)

### Community 974 - "Community 974"
Cohesion: 0.20
Nodes (15): DETECTION_LAYERS, GALLERY_ITEMS, LAYER_DESCRIPTIONS, LAYER_LABELS, LLM_ONLY_RULES, VISUAL_EXAMPLES, buildSubPageData(), CATEGORY_DESCRIPTIONS (+7 more)
...
Cohesion: 0.21
Nodes (13): addNpmInstallDefaults(), bootFixtureSession(), __dirname, FIXTURES_DIR, formatDuration(), REPO_ROOT, runInject(), runInstall() (+5 more)
...
Cohesion: 0.06
Nodes (55): Path, _cross_community_surprises(), _cross_file_surprises(), _is_concept_node(), _is_file_node(), Graph analysis: god nodes (most connected), surprising connections (cross-commun, Return True if this node is a manually-injected semantic concept node     rathe, Cross-file edges between real code/doc entities, ranked by a composite     surp (+47 more)
...
Cohesion: 0.12
Nodes (15): dependencies, react, react-dom, devDependencies, vite, @vitejs/plugin-react, name, private (+7 more)
...
Cohesion: 0.17
Nodes (15): Exception, CookieConflict, Attempted to look up a cookie by name but multiple cookies exist., check_format(), check_required_fields(), normalize_fields(), Validator module - checks that parsed documents meet schema requirements before, Run all validation checks on a parsed document. Raises ValidationError on failur (+7 more)

### Community 1019 - "Community 1019"
Cohesion: 0.16
Nodes (27): Path, install(), Install graphify post-commit and post-checkout hooks in the nearest git repo., _make_git_repo(), Tests for hooks.py - git hook install/uninstall., Hook scripts must embed sys.executable so the hook works without the     graphi, End-to-end: the files written to .git/hooks must be nohup-free (#1161)., A Windows-style core.hooksPath must raise (loud failure), not silently     crea (+19 more)
...
Cohesion: 0.17
Nodes (15): handle_upload(), Accept a list of file paths, run the full pipeline on each,     and return a su, batch_parse(), parse_and_save(), parse_file(), parse_json(), parse_markdown(), parse_plaintext() (+7 more)

### Community 1023 - "Community 1023"
Cohesion: 0.12
Nodes (9): Generate Tailwind CSS configuration files., Add full color palette (50-950 shades) for a base color.          Args:, TailwindConfigGenerator, Test plugin recommendations., Test validating valid configuration., Test that written config contains expected content., Test generating complete TypeScript configuration., Test default output path for TypeScript. (+1 more)
...
Cohesion: 0.15
Nodes (7): Account, delete, insert, update, AccountService, AccountStatus, Notifiable
...
Cohesion: 0.13
Nodes (14): compilerOptions, esModuleInterop, isolatedModules, jsx, module, moduleResolution, noEmit, skipLibCheck (+6 more)
...
Cohesion: 0.20
Nodes (15): ask(), chooseInstallProviders(), collectInstallDetections(), defaultDetectedProviders(), formatProviderList(), hasRealSkillEntries(), link(), normalizeProviderName() (+7 more)
...
Cohesion: 0.29
Nodes (15): Path, extract_terraform(), Extract Terraform/HCL blocks and the references between them via tree-sitter., _labels(), Tests for the Terraform/HCL extractor (graphify/extract.py, issue #187)., _rel_pairs(), test_cross_file_references_resolve_after_merge(), test_depends_on_edge() (+7 more)

### Community 1122 - "Community 1122"
Cohesion: 0.15
Nodes (12): getCurrentSectionId(), header, nav, navLinks, navToggle, reducedMotion, revealObserver, revealTargets (+4 more)
...
Cohesion: 0.13
Nodes (12): AP_OUTPUT, apJson, BROWSER_MODULES, chromeManifest, code, DETECTOR_OUTPUT, __dirname, DIST (+4 more)
...
Cohesion: 0.23
Nodes (8): detectUrl(), runVisualContrastFallback(), serializeDesignSystemForBrowser(), detectHtml(), STATIC_ELEMENT_RULES, mergeDesignSystemFindings(), finding(), getAP()
...
Cohesion: 0.17
Nodes (20): Any, Path, introspect_cargo(), _load_toml(), _member_manifest_paths(), Cargo manifest introspection for workspace-internal crate dependencies., Return crate nodes and internal dependency edges from Cargo manifests., Real workspace: pin raw graph fields while excluding registry-only deps. (+12 more)

### Community 1169 - "Community 1169"
Cohesion: 0.14
Nodes (12): Closers, Denylist, Internal jargon leaking out, Marketing voice, Patterns the validator can't catch, Principles, Punctuation, Stolen-engineer diction (+4 more)

### Community 1170 - "Community 1170"
Cohesion: 0.27
Nodes (14): Path, extract_astro(), Extract imports from .astro files: frontmatter (TS) + template regex fallback., _import_targets(), Tests for `.astro` extraction (#850).  Astro files have a TypeScript frontmatt, Astro permits frontmatter-less files (pure-HTML pages). Must not raise., Without this, detect.py silently drops `.astro` from the AST pass (#850)., test_astro_is_in_code_extensions() (+6 more)
...
Cohesion: 0.23
Nodes (13): assertInsideRepo(), assetRoot, checkAssets(), checkOnly, __dirname, dirsToSync, exists(), fileHash() (+5 more)

### Community 1181 - "Community 1181"
Cohesion: 0.16
Nodes (7): BENCH_SCRIPT, FIXTURES, run(), SCRIPT, withoutDesignSystemArgs(), withStaticFixture(), writeStaticFixture()

### Community 1182 - "Community 1182"
Cohesion: 0.22
Nodes (11): The Read|Glob PreToolUse hook nudges toward the graph instead of raw reads.  C, Reading the graph's own report must not start a go-read-the-graph loop., A nudge is additionalContext only - the hook must exit 0, never deny., _run(), test_glob_pattern_nudges(), test_never_blocks(), test_nudge_payload_is_valid_pretooluse_json(), test_nudges_on_source_read_with_graph() (+3 more)
...
Cohesion: 0.15
Nodes (12): compilerOptions, esModuleInterop, isolatedModules, jsx, module, moduleResolution, noEmit, skipLibCheck (+4 more)
...
Cohesion: 0.13
Nodes (20): Path, Namespace, bless(), check(), _expected_path(), main(), _parse_args(), A single generated file: its repo-relative path and exact bytes. (+12 more)
...
Cohesion: 0.15
Nodes (13): 161 Industry-Specific Reasoning Rules, Automated Releases, Available Styles (67), Design System Command (Advanced), Features, How Design System Generation Works, Intelligent Design System Generation, License (+5 more)

### Community 1246 - "Community 1246"
Cohesion: 0.24
Nodes (9): Geometry, Point, Shape, Base, area(), Circle, describe(), Float64 (+1 more)

### Community 1247 - "Community 1247"
Cohesion: 0.17
Nodes (11): dependencies, axios, react, devDependencies, typescript, name, scripts, build (+3 more)

### Community 1248 - "Community 1248"
Cohesion: 0.18
Nodes (10): BaseProcessor, build, Processor, Result, leaf, Payload, top, tick (+2 more)
...
Cohesion: 0.17
Nodes (11): dependencies, react, react-dom, name, private, scripts, build, dev (+3 more)

### Community 1299 - "Community 1299"
Cohesion: 0.17
Nodes (11): devDependencies, name, private, scripts, build, dev, preview, type (+3 more)
...
Cohesion: 0.24
Nodes (10): buildScanConfig(), devtoolsTabs, ensureContentScriptInjected(), getSettings(), getState(), panelPorts, sendScanToTab(), tabState (+2 more)

### Community 1309 - "Community 1309"
Cohesion: 0.20
Nodes (12): chooseInstallPlan(), chooseInstallScope(), defaultInstallScope(), formatInstallDetectionLines(), formatPathForDisplay(), getFlagValue(), getInstallScopeValue(), installRootForScope() (+4 more)
...
Cohesion: 0.18
Nodes (9): datetime, _classify(), format_prs_text(), Plain-text PR summary for MCP output (no ANSI)., make_pr(), Tests for graphify/prs.py., Build a minimal PRInfo with sensible defaults., TestClassify (+1 more)

### Community 1312 - "Community 1312"
Cohesion: 0.21
Nodes (12): Path, _append_rationale_attr(), _is_sentence_like_rationale_label(), load_validated_semantic_fragment(), Load and validate a semantic chunk, rejecting oversize files before parsing., Clean up a semantic extraction fragment in-place.      Operations:     1. Rem, Return True if *label* looks like prose / rationale text rather than an     ent, Append one or more rationale strings to *node*'s ``rationale`` attribute. (+4 more)

### Community 1313 - "Community 1313"
Cohesion: 0.17
Nodes (11): Anti-pattern detection rules, Build, Test, and Development Commands, Coding Style & Naming Conventions, Commit & Pull Request Guidelines, Contributor Notes, Generated Provider Output Policy, Project Structure & Module Organization, Releases (+3 more)
...
Cohesion: 0.23
Nodes (13): CompletedProcess, Path, _make_docs_corpus(), Integration tests for incremental graphify extract behavior., After a full extract run, manifest.json must exist (or run fails before writing, If manifest.json + graph.json exist, incremental mode message is shown., Without manifest.json, full scan message is shown (not incremental)., #1347: no-op incremental no-cluster extract must not overwrite graph.json. (+5 more)

### Community 1318 - "Community 1318"
Cohesion: 0.17
Nodes (12): _install_capturing_openai(), Like _install_fake_openai but records kwargs passed to create()., test_call_openai_compat_explicit_extra_body_skips_ollama_auto_derive(), test_call_openai_compat_extra_body_wins_over_moonshot_default(), test_call_openai_compat_uses_explicit_extra_body(), test_non_ollama_backend_gets_no_num_ctx_extra_body(), test_ollama_extra_body_sets_num_ctx_and_keep_alive(), test_ollama_num_ctx_env_override() (+4 more)

### Community 1319 - "Community 1319"
Cohesion: 0.17
Nodes (11): Common issues, Prerequisites, Step 1. Run /impeccable critique, Step 2. Open the visual overlay, Step 3. Merge the two assessments, Step 4. Fix the findings, Step 5. Re-run when you are done, What the automated detector does (+3 more)

### Community 1320 - "Community 1320"
Cohesion: 0.17
Nodes (12): Code of Conduct, Commit Message Format, Contributing to UI/UX Pro Max, Development Workflow, Fork & Clone, Getting Started, Prerequisites, Project Structure (+4 more)

### Community 1321 - "Community 1321"
Cohesion: 0.25
Nodes (10): main(), __device__, dot(), host_norm(), saxpy(), Vec3, x, y (+2 more)
...
Cohesion: 0.25
Nodes (9): geometry, main, point, constants, circle_area(), origin(), print_area(), translate() (+1 more)

### Community 1324 - "Community 1324"
Cohesion: 0.24
Nodes (3): ApiClient, BaseProcessor, Authenticator
...
Cohesion: 0.18
Nodes (10): devDependencies, name, private, scripts, build, dev, preview, type (+2 more)
...
Cohesion: 0.24
Nodes (11): copyProviderHooks(), fileHasImpeccableHookMarker(), hookArtifactsForProvider(), hookScriptPathForProvider(), mergeHookManifests(), pruneImpeccableHookFromManifest(), readJsonFile(), rewriteHookCommandsForSkillRoot() (+3 more)
...
Cohesion: 0.19
Nodes (7): compute_pr_impact(), _path_match(), True if graph_src and pr_file refer to the same file (path-boundary safe)., Return (communities_touched, nodes_affected) for a set of changed files., 3 nodes across 2 communities, 2 distinct source files., TestComputePrImpact, TestPathMatch

### Community 1489 - "Community 1489"
Cohesion: 0.10
Nodes (22): Any, build_python_symbol_index(), existing_edge_pairs(), _node_source_stem(), Return the stem of a node's source file., Build ``(module_stem, normalized_symbol_name) -> node_ids``.      This index i, Resolve raw Python calls using explicit import evidence.      Only ``from modu, Return all existing source/target/relation edge triples.      Includes relatio (+14 more)
...
Cohesion: 0.18
Nodes (10): Build, Demo account, Next step, TrackDocs, ตั้งค่า environment, ติดตั้ง, รันโปรเจกต์, สิ่งที่มีในขั้นนี้ (+2 more)
...
Cohesion: 0.31
Nodes (7): main(), BaseProcessor, Logger, Reader, ReaderLogger, NewServer(), Server

### Community 1507 - "Community 1507"
Cohesion: 0.31
Nodes (6): BaseProcessor, Config, HttpClient, Loggable, String, createClient()

### Community 1508 - "Community 1508"
Cohesion: 0.28
Nodes (8): Config, HttpClient, Int, Loggable, String, BaseClient, HttpClientFactory, Loggable
...
Cohesion: 0.44
Nodes (9): countByPage(), getBufferPath(), readBuffer(), readBufferInternal(), readBufferStrict(), removeEntries(), stageEntry(), truncateBuffer() (+1 more)
...
Cohesion: 0.31
Nodes (7): ../../styles/detector-lab.css, countByRule(), measureFixture(), nowMs(), roundMs(), routeFor(), slug()

### Community 1622 - "Community 1622"
Cohesion: 0.20
Nodes (10): Architecture, Best Practices, Developer Guide, Questions?, Reference Documentation, Repository Structure, Skill (`skill/SKILL.src.md`), Skill Writing (+2 more)
...
Cohesion: 0.27
Nodes (5): dark, impeccableShikiThemes, light, contrastRatio(), relativeLuminance()

### Community 1627 - "Community 1627"
Cohesion: 0.20
Nodes (10): CLI, Community & Ecosystem, Contributing, Design hook, Impeccable, License, See It In Action, Supported Tools (+2 more)
...
Cohesion: 0.27
Nodes (6): run(), runAsync(), SCRIPT_PATH, setup(), write(), writeMonorepo()

### Community 1636 - "Community 1636"
Cohesion: 0.22
Nodes (4): createAppendTarget(), createDocument(), REPO_ROOT, SCRIPT
...
Cohesion: 0.20
Nodes (7): Regression tests for install-time instruction strings.  These strings live in, All ten install surfaces must point the assistant at `graphify query`     as th, The pre-fix instructions told assistants to read GRAPH_REPORT.md as     their f, The fix demotes GRAPH_REPORT.md, it doesn't delete the reference.     Most inst, test_every_install_surface_recommends_graphify_query(), test_no_install_surface_demands_reading_the_full_report_first(), test_report_is_still_referenced_as_fallback()
...
Cohesion: 0.20
Nodes (9): Common issues, How Impeccable works, Prerequisites, Step 1. Install, Step 2.5. Capture the visual system, Step 2. Set up Impeccable for your project, Step 3. Polish something, What to try next (+1 more)

### Community 1641 - "Community 1641"
Cohesion: 0.20
Nodes (9): Common issues, Prerequisites, Step 1. Start live mode, Step 2. Pick an element, Step 3. Cycle through the three variants, Step 4. Accept one, Step 5. Stop live mode, What to try next (+1 more)

### Community 1642 - "Community 1642"
Cohesion: 0.20
Nodes (6): Architecture, Git Workflow, Prerequisites, Project Overview, Search Command, Sync Rules

### Community 1643 - "Community 1643"
Cohesion: 0.29
Nodes (7): applyTheme(), getStoredPref(), initThemeToggle(), LABELS, resolveTheme(), systemTheme(), TITLES
...
Cohesion: 0.14
Nodes (19): Path, _bash_file_stem(), _file_node_id_for_path(), find_unique_python_symbol(), ImportedSymbol, _module_stem(), parse_python_import_aliases(), Deterministic symbol indexing and conservative cross-file resolution helpers. (+11 more)
...
Cohesion: 0.31
Nodes (4): BUNDLE_DOWNLOAD_PROVIDERS, DOWNLOAD_PROVIDERS, FILE_DOWNLOAD_PROVIDER_CONFIG_DIRS, FILE_DOWNLOAD_PROVIDERS
...
Cohesion: 0.28
Nodes (5): expectedHookDests(), CLI, createFakeLinkSource(), createPrefixedInstall(), writeSkill()

### Community 1769 - "Community 1769"
Cohesion: 0.31
Nodes (6): content, currentFindings, escapeHtml(), refreshForCurrentSelection(), render(), renderEmpty()
...
Cohesion: 0.22
Nodes (8): Category, Chrome Web Store Listing, Detailed description, Language, Name, Privacy policy URL, Short description (132 chars max), Single purpose description

### Community 1786 - "Community 1786"
Cohesion: 0.22
Nodes (8): 2025 Controlled Experiments, Empirical Results, Experiment A: Multi-Part Instruction Compliance, Experiment B: Decoding Suboptimality, Experiment C: Context Degradation, Key Conclusion, Prompt Stimulus Effectiveness (Microsoft Research), Seasonal Output Variation
...
Cohesion: 0.22
Nodes (8): Exit Codes, Impeccable CLI, License, Options, Part of Impeccable, Quick Start, Requirements, What It Detects

### Community 1795 - "Community 1795"
Cohesion: 0.22
Nodes (8): Accessibility & Inclusion, Anti-references, Brand Personality, Design Principles, Lumina, Product Purpose, Register, Users

### Community 1796 - "Community 1796"
Cohesion: 0.25
Nodes (7): btnScan, btnToggle, countLabel, countNumber, getActiveTabId(), loadState(), scanError

### Community 1797 - "Community 1797"
Cohesion: 0.22
Nodes (8): Chain of Verification, Explicit Syntax Binding, Prompt Engineering Techniques, Psychological Pattern Matching, Reverse Prompting, Self-Grading Loop, Verification Loops, XML-Structured Prompts
...
Cohesion: 0.25
Nodes (5): TButton, TPanel, TLabel, TSampleForm, TTimer

### Community 1806 - "Community 1806"
Cohesion: 0.32
Nodes (6): main(), Point, Shape, add(), Color, multiply()
...
Cohesion: 0.25
Nodes (3): ANTIPATTERNS, GATED_PROVIDERS, RULE_ENGINE_SUPPORT
...
Cohesion: 0.13
Nodes (20): _describe_node(), format_node_refs(), generate_call_table_rows(), generate_section_intro(), group_nodes_by_file(), is_zh(), pick_text(), Group selected nodes by source file for Mermaid subgraphs. (+12 more)
...
Cohesion: 0.57
Nodes (6): confirm(), detectCli(), formatFindings(), formatFindingSummary(), handleStdin(), printUsage()
...
Cohesion: 0.29
Nodes (3): POLL_SCRIPT, REPO_ROOT, SERVER_SCRIPT
...
Cohesion: 0.32
Nodes (4): FeatureCard(), FeatureCardProps, PricingCard(), PricingCardProps

### Community 1889 - "Community 1889"
Cohesion: 0.29
Nodes (7): App(), assertIntegerStat(), foundationCards, hardManualCards, hardManualCountsByName, largeManualItems, workshopStats

### Community 1890 - "Community 1890"
Cohesion: 0.25
Nodes (5): featureCard, featureGrid, heroHook, heroTitle, page
...
Cohesion: 0.17
Nodes (18): introspect_postgres(), _quote_ident(), Connect to PostgreSQL, reconstruct DDL, and extract via extract_sql()., Double-quote a PostgreSQL identifier, escaping embedded double-quotes., _make_mock_psycopg(), _q(), Baseline: tables, views, routines, and a single-column FK all survive., Reserved-word and special-character table names must survive DDL round-trip. (+10 more)
...
Cohesion: 0.25
Nodes (7): Development, GitHub Authentication, How It Works, Installation, License, uipro-cli, Usage

### Community 1906 - "Community 1906"
Cohesion: 0.25
Nodes (8): Frontmatter Support, Harness Skills Capabilities Reference, Hook surface used by Impeccable, Native Subagent Directory Structure, Official Documentation, Placeholder / Variable Substitution, Skill Directory Structure, Spec Compliance

### Community 1907 - "Community 1907"
Cohesion: 0.25
Nodes (6): ../../../cli/engine/detect-antipatterns.mjs, __dirname, MIME, ROOT, __dirname, FIXTURES
...
Cohesion: 0.25
Nodes (7): compilerOptions, module, outDir, strict, target, extends, include
...
Cohesion: 0.25
Nodes (7): Architectural Patterns, Architecture Components, Chunked Task Execution, Example: Developer Knowledge API, How It Reduces Truncation, Lazy-Loaded Skills, Model Context Protocol (MCP)

### Community 1916 - "Community 1916"
Cohesion: 0.25
Nodes (6): code, __dirname, MODULES, OUTPUT, ROOT, SITE_OUTPUT

### Community 1917 - "Community 1917"
Cohesion: 0.29
Nodes (7): ART_PATH, __dirname, __filename, generateOgImage(), getCommandCount(), OUTPUT_PATH, ROOT_DIR
...
Cohesion: 0.20
Nodes (9): _audit_allowlist(), audit_coverage(), headings(), The full set of v8 headings the audit may skip for this host., Resolve the rendered-name -> source-fragment map for this split platform., Return the ATX markdown headings in source order, ignoring code fences.      A, Assert every heading of THIS host's v8 body single-homes in its render.      T, The git ref for a split host's own pre-split skill body. (+1 more)

### Community 1921 - "Community 1921"
Cohesion: 0.16
Nodes (17): iter_raw_calls(), Resolve unqualified raw calls conservatively after all files are known.      T, Return raw calls from all per-file extraction fragments.      Parameter is ``S, resolve_cross_file_raw_calls(), Tests for graphify.symbol_resolution., A non-dict per_file entry (e.g. junk fragment) must be silently skipped., `raw_calls` that isn't a list must yield empty., Items inside `raw_calls` list that aren't dicts must be dropped. (+9 more)
...
Cohesion: 0.39
Nodes (6): knownRoutes(), normalizeRoute(), pageRoute(), ROOT, routeFromUrl(), walk()
...
Cohesion: 0.14
Nodes (8): BaseProcessor, Processor, Result, HttpClient, List, String, SampleService, Override

### Community 1927 - "Community 1927"
Cohesion: 0.33
Nodes (5): Processor, Result, Logger, HashMap, T
...
Cohesion: 0.29
Nodes (5): args, buffer, cwd, pageUrlFilter, remaining
...
Cohesion: 0.29
Nodes (5): cardStyle, gridStyle, hookStyle, pageStyle, titleStyle
...
Cohesion: 0.12
Nodes (17): build_section_node_map(), classify_edges(), detect_lang(), html_comment_text(), load_report(), main(), Generate call-flow architecture HTML from graphify output files., Load GRAPH_REPORT.md if it exists. (+9 more)
...
Cohesion: 0.38
Nodes (6): FIXTURES_DIR, GET(), getStaticPaths(), ROOT, walk(), withDetectorScript()
...
Cohesion: 0.12
Nodes (16): 1. Preflight, 2. Find the project, 3. Decide what to test, 4. Run, 4a. Read the result — plan, or product?, 5. On failure → download the artifact, 6. Report, (a) An existing test covers the change (+8 more)
...
Cohesion: 0.29
Nodes (7): dependencies, css-select, css-tree, domutils, fflate, htmlparser2, marked

### Community 2102 - "Community 2102"
Cohesion: 0.48
Nodes (5): collectPluginVersions(), extractFromFile(), readSkillFrontmatterVersion(), skillMd(), writeFixture()
...
Cohesion: 0.29
Nodes (6): Details when the default path is not enough, How context changes the output, Keeping context fresh, The fast path, The most important choice: brand or product, What goes where

### Community 2106 - "Community 2106"
Cohesion: 0.29
Nodes (6): DESIGN.md awareness, Details when the default path is not enough, Fast path, How to read results, Managing intentional findings, What it checks
...
Cohesion: 0.60
Nodes (3): detectUrl(), runVisualContrastFallback(), serializeDesignSystemForBrowser()
...
Cohesion: 0.29
Nodes (6): Απόρρητο, Δημιουργήθηκε στο graphify — Penpax, Εγκατάσταση, Πώς λειτουργεί, Τι λαμβάνετε, Χρήση
...
Cohesion: 0.29
Nodes (6): Gebouwd op graphify — Penpax, Gebruik, Hoe het werkt, Installatie, Privacy, Wat je krijgt
...
Cohesion: 0.29
Nodes (7): Claude Marketplace install fails with "Zip file contains a symbolic link", Design system output is cut off / fields truncated, `npm install -g uipro-cli` fails with permission error, Python not found when running design system commands, Troubleshooting, `uipro uninstall` says "No installed AI skill directories detected", `uipro: unknown command 'uninstall'` or `unknown command 'update'`
...
Cohesion: 0.53
Nodes (5): sample.sh script, APP_ENV, build(), deploy(), test_suite()
...
Cohesion: 0.17
Nodes (13): build_label_index(), node_is_resolvable_symbol(), normalise_callable_label(), Normalize a node label into the key used for call resolution., Return True when a node is suitable for deterministic symbol lookup.      Requ, Build label -> node id list for conservative cross-file resolution., Document/paper/image/concept nodes MUST NOT be indexed as call targets,     eve, label index must not include document/paper/image nodes even when     label and (+5 more)
...
Cohesion: 0.18
Nodes (10): StatusBadgeProps, ShipmentQueryFilters, ImageType, ReceivePayload, ShipmentCounter, ShipmentFormValues, ShipmentImageDraft, ShipmentStatus (+2 more)
...
Cohesion: 0.33
Nodes (5): AccentBox, animatedPanel, Card, Hero, inlineStyles
...
Cohesion: 0.33
Nodes (5): 1. Overview, 2. Color, 3. Typography, 4. Components, Design System: Stateful Expense System

### Community 2189 - "Community 2189"
Cohesion: 0.33
Nodes (3): Cited Studies, Further Reading, References
...
Cohesion: 0.33
Nodes (5): Additional context, Expected behavior, Provider & environment, Steps to reproduce, What happened?

### Community 2198 - "Community 2198"
Cohesion: 0.33
Nodes (5): STEP 12 Admin Pages Plan, งานย่อย, เกณฑ์ผ่าน, เป้าหมาย, แนวทาง
...
Cohesion: 0.33
Nodes (5): Details when the default path is not enough, Inline ignore comments, Shared or local, The usual path, Value ignores

### Community 2202 - "Community 2202"
Cohesion: 0.33
Nodes (5): Gemini Thinking Level Configuration, Parameter Tuning, Temperature, Temperature and Top-p, Top-p (Nucleus Sampling)

### Community 2203 - "Community 2203"
Cohesion: 0.33
Nodes (6): Analysis and Documentation, Code Generation, Continuation Handling, General Purpose, Reference Prompts, Step-by-Step Reasoning

### Community 2204 - "Community 2204"
Cohesion: 0.33
Nodes (5): Cognitive Shortcuts, Error Avoidance as Truncation Driver, Metacognitive Laziness, Seasonal Behavior Anomalies, The LazyBench Discovery

### Community 2205 - "Community 2205"
Cohesion: 0.33
Nodes (5): Context Window Asymmetry, Developer Platform Differences, Output Limits and Consumer Truncation, Terminal and CLI Integration, The Consumer Middleware Problem
...
Cohesion: 0.33
Nodes (5): __dirname, ICONS_DIR, ROOT, SIZES, svgContent

### Community 2208 - "Community 2208"
Cohesion: 0.33
Nodes (5): Baseline state (2026-05-20, previous cheap tier), How it works, Run, Scenarios, Skill-behavior tests
...
Cohesion: 0.33
Nodes (5): How it works, Pin commands back as shortcuts, Pitfalls, Try it, When to use it
...
Cohesion: 0.60
Nodes (5): Regression tests for `graphify explain` arrow direction (#853)., _run(), test_callee_shows_callers_as_inbound(), test_caller_shows_callee_as_outbound(), _write_graph()
...
Cohesion: 0.40
Nodes (5): sample, FCL, SamplePackage, LCL, sampleutils

### Community 2221 - "Community 2221"
Cohesion: 0.50
Nodes (3): Get-Data(), Invoke-Main(), Process-Items()
...
Cohesion: 0.50
Nodes (3): parseTargetOptions(), parseTargetPath(), TargetArgError
...
Cohesion: 0.38
Nodes (9): Any, Path, build_tree(), _common_root(), emit_html(), _make_truncation_leaf(), tree_html — emit a D3 v7 collapsible-tree HTML view of a graph.  A self-contai, Build a ``{name, total_count, children}`` hierarchy.      Each leaf is either (+1 more)
...
Cohesion: 0.29
Nodes (9): Path, _expected_artifacts(), _has_build(), Packaging guard (#1121 follow-up): the 5 skillgen guards check the *repo tree*,, Every distinct skill body a platform installs (the SKILL.md is copied from, Every committed skill body + references/*.md (per host) + always_on/*.md block., _skill_bodies(), test_skill_artifact_ships_in_wheel() (+1 more)
...
Cohesion: 0.20
Nodes (3): COMPLETE_SCRIPT, REPO_ROOT, SERVER_SCRIPT
...
Cohesion: 0.22
Nodes (6): baseShipments, demoCredentials, demoCustomers, demoPasswordsByEmail, demoUsers, now
...
Cohesion: 0.40
Nodes (4): Details when the default path is not enough, Fast path, Handling intentional findings, What it does
...
Cohesion: 0.50
Nodes (4): __dirname, looksLikeDetectTarget(), main(), SKILL_COMMANDS
...
Cohesion: 0.40
Nodes (4): css, parser, tailwindDirectives, $schema

### Community 2322 - "Community 2322"
Cohesion: 0.40
Nodes (5): 23 Commands, Anti-Patterns, The Skill: impeccable, Usage Examples, What's Included

### Community 2323 - "Community 2323"
Cohesion: 0.40
Nodes (5): Installation, Option 1: CLI installer (Recommended), Option 2: Git Submodule, Option 3: Download from Website, Option 4: Copy from Repository

### Community 2324 - "Community 2324"
Cohesion: 0.40
Nodes (4): Alternatives considered, Proposed solution, Provider(s) this applies to, What problem does this solve?
...
Cohesion: 0.40
Nodes (4): Impact on Output Quality, Pattern Reinforcement, Placeholder Propagation, Training Data Bias

### Community 2331 - "Community 2331"
Cohesion: 0.40
Nodes (4): collections, reference, skills, tutorials

### Community 2332 - "Community 2332"
Cohesion: 0.40
Nodes (4): How it works, Pitfalls, Try it, When to use it
...
Cohesion: 0.47
Nodes (5): _extras(), The claude backend must be installable via an extra, and the missing-package me, test_anthropic_extra_exists(), test_anthropic_in_all_extra(), test_backend_pkg_hint_points_at_uv_tool_and_extra()
...
Cohesion: 0.40
Nodes (5): Global Install (Available for All Projects), Installation, Other CLI Commands, Using Claude Marketplace (Claude Code), Using CLI (Recommended)
...
Cohesion: 0.50
Nodes (3): For git commit hook, graphify reference: commit hook and native AGENTS.md integration, For native AGENTS.md integration (Trae)
...
Cohesion: 0.25
Nodes (7): load_platforms(), Platform, One render unit parsed from platforms.toml., The prose file name the lean-core hooks pointer names for this host., Parse platforms.toml into Platform records, keyed by platform name., Render the YAML frontmatter from the platform's name and description.      Onl, _render_frontmatter()
...
Cohesion: 0.25
Nodes (3): __dirname, REPO_ROOT, SCRIPT
...
Cohesion: 0.50
Nodes (3): Card, Hero, smoothPanel

### Community 2483 - "Community 2483"
Cohesion: 0.50
Nodes (4): Adding a New Provider, Build System Details, Key Functions, Provider Config Options

### Community 2484 - "Community 2484"
Cohesion: 0.50
Nodes (4): Build fails with YAML parsing errors, Output doesn't match expectations, Provider doesn't recognize the files, Troubleshooting

### Community 2485 - "Community 2485"
Cohesion: 0.50
Nodes (4): Building, Commands, Prerequisites, What Gets Generated
...
Cohesion: 0.50
Nodes (3): Current fixtures, Framework fixtures, Layout

### Community 2532 - "Community 2532"
Cohesion: 0.50
Nodes (3): Checklist, Summary, Type of change
...
Cohesion: 0.29
Nodes (4): COMPLETE_SCRIPT, REPO_ROOT, RESUME_SCRIPT, STATUS_SCRIPT
...
Cohesion: 0.50
Nodes (3): [LLM Laziness](laziness/), Research, Topics
...
Cohesion: 0.67
Nodes (3): Architecture & Contributing, For Contributors, For Users
...
Cohesion: 0.40
Nodes (4): FIXTURES_DIR, getStaticPaths(), ROOT, walk()
...
Cohesion: 0.40
Nodes (4): Path, extract_blade(), Laravel Blade template extractor. Moved verbatim from graphify/extract.py., Extract @include, <livewire:> components, and wire:click bindings from Blade tem

### Community 2993 - "Community 2993"
Cohesion: 0.40
Nodes (4): Path, extract_zig(), Zig extractor (tree-sitter). Moved verbatim from graphify/extract.py., Extract functions, structs, enums, unions, and imports from a .zig file.
...
## Knowledge Gaps
- **13579 isolated node(s):** `graphifyy`, `{ loadFoundation, validateConfig }`, `utils`, `Notifiable`, `AccountStatus` (+13574 more)
...
- **Why does `printSummary()` connect `Community 38` to `Community 2433`, `Community 2448`, `Community 2453`, `Community 2463`, `Community 42`, `Community 43`, `Community 2476`, `Community 45`, `Community 47`, `Community 49`, `Community 51`, `Community 53`, `Community 55`, `Community 57`, `Community 2617`, `Community 59`, `Community 3003`, `Community 61`, `Community 3004`, `Community 697`, `Community 64`, `Community 66`, `Community 3177`, `Community 2411`, `Community 2416`, `Community 2423`, `Community 2170`, `Community 2428`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `renderBrowserFindings()` connect `Community 2411` to `Community 38`, `Community 191`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `renderBrowserFindings()` connect `Community 2463` to `Community 211`, `Community 38`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **What connects `graphify - extract · build · cluster · analyze · report.`, `graphify CLI - `graphify install` sets up the Claude Code skill.`, `Read a packaged always-on instruction block from graphify/always_on/.      The` to the rest of the system?**
  _15626 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.0068323843910567976 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.015810276679841896 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.015778909989192527 - nodes in this community are weakly interconnected._