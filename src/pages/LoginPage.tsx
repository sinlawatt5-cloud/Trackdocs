      ...
      <div className="trackdocs-shell relative flex min-h-[100dvh] items-center justify-center overflow-hidden px-4 py-6 sm:px-6 sm:py-8">
        ...
        <section className="w-full max-w-[560px]">
          <Card
            tone="glass"
            padding="lg"
            className="trackdocs-login-card trackdocs-signal-panel trackdocs-page-entrance relative overflow-hidden border border-[rgba(15,23,42,0.12)] bg-[linear-gradient(180deg,rgba(250,250,248,0.96),rgba(242,244,239,0.92))] p-6 shadow-[0_30px_100px_rgba(15,23,42,0.16)] sm:p-8"
          >
            <div className="trackdocs-entrance flex items-center gap-4 sm:gap-5">
            ...
            <div className="trackdocs-entrance mt-8">
              <h1 className="trackdocs-login-title">ยินดีต้อนรับกลับ</h1>
              <p className="trackdocs-login-subtitle mt-3 max-w-xl">
                ใช้อีเมลและรหัสผ่านเพื่อเข้าใช้งาน TrackDocs ตามสิทธิ์ของคุณ
              </p>
              <div className="trackdocs-route-line mt-6 opacity-70" aria-hidden="true" />
            </div>

            <form className="trackdocs-stagger-list mt-7 space-y-5" onSubmit={form.handleSubmit(handleSubmit)} noValidate>
              <Input
                id="login-email"
                type="email"
                autoComplete="email"
              ...
              {errorMessage ? (
                <div className="trackdocs-entrance rounded-[20px] border border-[rgba(244,63,94,0.18)] bg-[rgba(255,241,242,0.88)] px-4 py-3 trackdocs-text-body text-rose-600">
                  {errorMessage}
                </div>
              ) : null}
            ...
            <div className="trackdocs-login-note trackdocs-entrance mt-6 rounded-[22px] border border-[rgba(15,23,42,0.08)] bg-[rgba(255,255,255,0.72)] px-4 py-4 text-center">
